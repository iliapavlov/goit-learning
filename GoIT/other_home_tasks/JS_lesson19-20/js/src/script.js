$(function () {
	...
	var skillsArray = _.sortBy(_.uniq(_.flatten(_.map(data, 'skills'))));
	var namesArray = _.sortBy(_.map(data, 'name'), 'friends'.length);
	var friendNamesArray = _.uniq(_.map(_.flatten(_.map(data, 'friends')), 'name'));
	
	console.log("skillsArray: ", skillsArray, "\n", "namesArray: ", namesArray, "\n", "friendNamesArray: ", friendNamesArray);
